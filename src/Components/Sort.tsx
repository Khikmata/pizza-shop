...
import { setSortType, toggleOrderBy, } from '../redux/reducers/filter/filterSlice';
import { ISort } from '../redux/reducers/filter/types';
...
const Sort = () => {
    ...
    const sort = useTypedSelector((state: RootState) => state.filterSlice.sort);
